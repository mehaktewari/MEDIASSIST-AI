...
export default function HealthRiskPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h2 className="text-2xl font-bold text-gray-800 mb-2">📊 Health Risk Score</h2>
      <p className="text-gray-500 text-sm mb-6">AI analyzes your medical report and calculates risk level</p>
      ...
      {result && (
        <div className="mt-6 space-y-4">
          ...
          <div className="bg-white border rounded-xl p-6 text-center shadow-sm">
            ...
            <p className="text-gray-500 text-sm mt-2">{result.urgency}</p>
          </div>

          {/* Risk Factors */}
          {result.risk_factors?.length > 0 && (
            <div className="bg-red-50 border border-red-200 rounded-xl p-4">
              <p className="font-bold text-red-700 mb-2">⚠️ Risk Factors</p>
          ...
          {result.positive_factors?.length > 0 && (
            <div className="bg-green-50 border border-green-200 rounded-xl p-4">
              <p className="font-bold text-green-700 mb-2">✅ Positive Factors</p>
              <ul className="space-y-1">
          ...
          {result.lifestyle_tips?.length > 0 && (
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
              <p className="font-bold text-blue-700 mb-2">💡 Lifestyle Tips</p>
              <ul className="space-y-1">
