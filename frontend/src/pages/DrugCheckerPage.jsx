...
export default function DrugCheckerPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h2 className="text-2xl font-bold text-gray-800 mb-2">💊 Drug Interaction Checker</h2>
      <p className="text-gray-500 text-sm mb-6">Check if medicines are safe to take together</p>
      ...
      {medicines.length < 6 && (
        <button
          onClick={addMedicine}
          className="w-full border-2 border-dashed border-gray-300 text-gray-400 py-2 rounded-lg text-sm hover:border-blue-400 hover:text-blue-500 transition-all mb-4"
        >
      ...
      {result && (
        <div className="mt-6 bg-white border rounded-xl p-6 shadow-sm">
          <div className="flex items-center gap-2 mb-4">
            ...
            <div>
              <p className="font-bold text-gray-800">Interaction Analysis</p>
              <p className="text-xs text-gray-400">Medicines: {result.medicines_checked.join(', ')}</p>
            </div>
          </div>
